...
<?php elseif($tpl=='view'):?>
	...
	<tr>
		...
		<td colspan="4"><input type="text" name="description" id="description" size="60" value="<?=isset($view['description'])?$view['description']:'';?>"></td></tr>
	<tr>
		<td><?=lang('content')?></td>
    ...
    <tr>
        <td><?=lang('linkurl')?></td>
        <td colspan="5"><input type="text" name="linkurl" id="linkurl" size="80" class="input-text" value="<?=isset($view['linkurl'])?$view['linkurl']:'';?>"></td></tr>
    <tr>
		<td><?=lang('hits')?></td>

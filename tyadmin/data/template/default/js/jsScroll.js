...
function jsScroll(obj, w, className)
{
	...
	obj.scrollBar = document.createElement('share_mi12_div');
	document.body.appendChild(obj.scrollBar);
	obj.scrollBarIndex = document.createElement('share_mi12_div');
	...
	if(!className) {
		obj.scrollBar.style.backgroundColor = '#ff6600';
...
function scrollResetSize(o) {
	...
	o.scrollBarIndex.style.width = 14 + 'px';
